...
home_root = r'C:\Users\josef'  # 在不同操作系统下面Home目录不一样
workspace = join(home_root,r'work/crack/my-capt-data/capt-python-36')  # 用于工作的训练数据集
model_path = join(home_root,r'work/crack/model')
